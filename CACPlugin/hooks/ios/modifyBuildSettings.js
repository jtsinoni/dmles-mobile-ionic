...
module.exports = function(context) {
    ...
    modifyBuildXCConfig(['DEVELOPMENT_TEAM = ZH933U85GQ', 'CODE_SIGN_IDENTITY = iPhone Developer: Logicole Logicole (Personal Team) (KMZ3QQ93BJ)'], 'debug');
    modifyBuildXCConfig(['DEVELOPMENT_TEAM = ZH933U85GQ', 'CODE_SIGN_IDENTITY = iPhone Distribution: Logicole Logicole (Personal Team) (KMZ3QQ93BJ)'], 'release');
